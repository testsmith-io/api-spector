...
import type { ResponsePayload, MockRoute, ScriptExecutionMeta, SentRequest, RunRequestResult } from '../../../../shared/types';
...
function HookResultsPanel ( { results }: { results: RunRequestResult[] } ) {
