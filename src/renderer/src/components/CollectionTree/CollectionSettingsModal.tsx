...
export function CollectionSettingsModal({ collection, onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        className="w-[480px] bg-surface-900 border border-surface-800 rounded-lg shadow-2xl flex flex-col max-h-[80vh]"
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-surface-800 shrink-0">
          <div>
            ...
            <p className="text-[10px] text-surface-600 mt-0.5">{collection.name} — TLS overrides for all requests in this collection</p>
          </div>
